...
/* Titles anim */
$('.fz75, .fz48, .fz46, .fz40, .fz55, .fz60, .fz70')
  .not('.no-anim')
  .each(anime);
...
var $element = $('.quiz-option__input');
...
$(document).ready(function ($) {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    quizResult.push(social);
    quizResult.push('Name: ' + name);
    quizResult.push('Phone: ' + phone);

    const data = Object.assign({}, quizResult);

    const url = 'http://127.0.0.1:5500/mail.php';
